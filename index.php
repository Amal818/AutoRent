...
.password-container i {
    ...
    cursor: pointer;
    color: #999; /* Optional: color for the eye icon */
}
        </style>
</head>
<body>
<div class="container" id="container">
    <div class="form-container sign-up-container">
        <form id="register-form" action="register.php" method="post" role="form" onsubmit="return validatePassword()">
            ...
            <div class="password-container">
                ...
                <i class="bi bi-eye-slash" id="toggleConfPassword" style="cursor: pointer;"></i>
            </div>
            <button type="submit" name="submit" onclick="showSignInForm()">Sign Up</button>
        </form>
    </div>
    <div class="form-container sign-in-container">
        <form id="login-form" action="login.php" method="post" role="form">
            ...
            <input type="text" placeholder="Email or Username" name="emailOrUsernameL" id="emailOrUsernameL"/>
            <div class="password-container">
            ...
            <button type="submit" name="submit" id="login-submit">Sign In</button>
        </form>
    </div>
...
<script>
    ...
    const loginPassword = document.querySelector('#passwordL');
    ...
    function validatePassword() {
        ...
        if (!passwordPattern.test(password)) {
            alert('Password must be between 6 and 20 characters and include at least one number, one letter, and one symbol.');
            return false;
        }
